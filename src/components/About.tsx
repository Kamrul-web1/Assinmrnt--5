    ...
    return (
        <div className=' grid grid-cols-2 container mx-auto py-[80px]'>
            <div >
                ...
                <h2 className='text-[80px] font-bold text-[#FF5722] pb-1.5'>Development  Stack </h2>
                ...
                <div className=' py-[50px] flex gap-4 '>
                    <button className='text-2xl text-[#FFFFFF]  bg-[#EC4899] p-2 rounded-md' >Explore Technologies</button>
